...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // node_modules/.pnpm/@shopify+ui-extensions@2023.7.2/node_modules/@shopify/ui-extensions/build/esm/surfaces/admin/components/AdminAction/AdminAction.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions@2023.7.2/node_modules/@shopify/ui-extensions/build/esm/surfaces/admin/components/Divider/Divider.mjs
  var Divider = createRemoteComponent("Divider");

  // node_modules/.pnpm/@shopify+ui-extensions@2023.7.2/node_modules/@shopify/ui-extensions/build/esm/surfaces/admin/components/Select/Select.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2023.7.2_xtaiqup5pn3t3z44n5l3nxt6oy/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/AdminAction/AdminAction.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2023.7.2_xtaiqup5pn3t3z44n5l3nxt6oy/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/Divider/Divider.mjs
  var Divider2 = createRemoteReactComponent(Divider);

  // node_modules/.pnpm/@shopify+ui-extensions-react@2023.7.2_xtaiqup5pn3t3z44n5l3nxt6oy/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/admin/components/Select/Select.mjs
  ...
  function updateVipProgram(id, vipProgram) {
    return __async(this, null, function* () {
  ...
  function getVipPrograms() {
    return __async(this, null, function* () {
      const response = yield makeGraphQLQuery(
        `query {
      shop {
  ...
  var TARGET = "admin.customer-details.action.render";
  var ActionExtension_default = reactExtension(TARGET, () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
    const { close, data } = useApi(TARGET);
    const [customerEmail, setCustomerEmail] = (0, import_react13.useState)("");
    const [vipLevel, setVipLevel] = (0, import_react13.useState)("");
    const [vipPrograms, setVipPrograms] = (0, import_react13.useState)([]);
    (0, import_react13.useEffect)(() => {
      (function getCustomer() {
        return __async(this, null, function* () {
          const programs = yield getVipPrograms();
          setVipPrograms(programs);
          setVipLevel(programs[0].value);
          fetch("https://admin-extension.gadget.app/my-route");
          const customerData = yield getCustomerQuery(data.selected[0].id);
          setCustomerEmail(customerData.data.customer.email);
        });
      })();
    }, [data]);
    const onSubmit = (0, import_react13.useCallback)(() => __async(this, null, function* () {
      yield updateVipProgram(data.selected[0].id, vipLevel);
      close();
    ...
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        AdminAction2,
        {
          primaryAction: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { onPress: onSubmit, children: "Save" }),
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: true, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
              "Current customer: ",
              customerEmail
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
            (vipPrograms == null ? void 0 : vipPrograms.length) > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Select2,
              {
                label: "VIP level",
                value: vipLevel,
