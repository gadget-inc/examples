...
This app was used for a [webinar](https://www.youtube.com/watch?v=OCez6zLb-NY) where a VIP/customer loyalty program was built using Shopify's admin action and block extensions.
